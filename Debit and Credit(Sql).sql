...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ 
 ...
 SELECT 
  `Customer Name`,`Account Number`,date(`Transaction Date`),  `Transaction Type`,  `Amount`,`Balance`,`Description`,  `Branch`,`Transaction Method`,
  `Currency`,`Bank Name`,
  `Week of Year`,`Risk Flag`,`Suspicious Transaction`
  FROM debit_credit_banking_data WHERE `Suspicious Transaction` = 'High Value';
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
